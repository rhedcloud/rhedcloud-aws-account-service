...
public class SamlProviderRequestCommand extends AwsAccountRequestCommand implements RequestCommand {
    ...
    public SamlProviderRequestCommand(CommandConfig cConfig) throws InstantiationException {
        ...
        String className = getProperties().getProperty("samlProviderClassName");
        if (className == null || className.equals("")) {
            String errMsg = "No samlProviderClassName property " + "specified. Can't continue.";
            logger.fatal(LOGTAG + errMsg);
            throw new InstantiationException(errMsg);
        }
        logger.info(LOGTAG + "samlProviderClassName is: " + className);
    ...
    public final Message execute(int messageNumber, Message aMessage) throws CommandException {
        ...
        SamlProvider reqSamlProvider = new SamlProvider();
        TestId testId = new TestId();
        try {
            reqSamlProvider = (SamlProvider) getAppConfig().getObjectByType(reqSamlProvider.getClass().getName());
