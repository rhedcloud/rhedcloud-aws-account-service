...
/**
 * A release tag for the RHEDcloud AWS Account Service.
 * <p>
 *
...
public abstract class ReleaseTag {
    ...
    public static String releaseName = "RHEDcloud AWS Account Service";
    public static String releaseNumber = "Release 1.0";
    public static String buildNumber = "Build ####";
    public static String copyRight = "Copyright 2016 Emory University. All Rights Reserved.";
