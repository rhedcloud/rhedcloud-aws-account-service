...
public class CreateIdmRoleAndResourcesForAuditorRole extends AbstractStep implements Step {
    ...
    protected List<Property> run() throws StepException {
        ...
        if (allocatedNewAccount && (newAccountId != null && !newAccountId.equals(PROPERTY_VALUE_NOT_AVAILABLE))) {
            ...
            String auditorRoleGuid = getStepPropertyValue("CREATE_LDS_GROUP_FOR_AUDITOR_ROLE", "guid");
            ...
            try {
                ...
                ent3.setEntitlementDN(getResource3EntitlementDn());
    ...
    public void rollback() throws StepException {
        super.rollback();
        String LOGTAG = getStepTag() + "[CreateIdmRoleAndResourcesForAuditorRole.rollback] ";
        long startTime = System.currentTimeMillis();
