...
public class MoveAccountToAdminOrg extends AbstractStep implements Step {
    ...
    public void rollback() throws StepException {
        ...
        boolean movedAccountBackToOrgRoot;
        ...
        if (newAccountId != null) {
            try {
                ...
                while (li.hasNext()) {
                    com.amazonaws.services.organizations.model.Account account = li.next();
    ...
    private void setRootSourceParentId(String id) throws StepException {
        if (id == null) {
            String errMsg = "rootSourceParentId property is null. Can't continue.";
            throw new StepException(errMsg);
        }
    ...
    private void setStandardSourceParentId(String id) throws StepException {
        if (id == null) {
            String errMsg = "standardSourceParentId property is null. Can't continue.";
            throw new StepException(errMsg);
        }
    ...
    private void setHipaaSourceParentId(String id) throws StepException {
        if (id == null) {
            String errMsg = "hipaaSourceParentId property is null. Can't continue.";
            throw new StepException(errMsg);
        }
    ...
    private void setDestinationParentId(String id) throws StepException {
        if (id == null) {
