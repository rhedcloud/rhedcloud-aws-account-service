    ...
    protected List<Property> run() throws StepException {
        ...
        if (Boolean.valueOf(createVpc)) {
            ...
            if (step1 != null) {
                ...
                logger.info(LOGTAG + "Property accountId from preceding step is: " + accountId);
            ...
            if (accountId == null || accountId.equalsIgnoreCase("null")) {
                ...
                if (step2 != null) {
                    ...
                    String errMsg = "Step GENERATE_NEW_ACCOUNT not found. Cannot determine whether or not to authorize the new account requestor.";
                    logger.error(LOGTAG + errMsg);
                    throw new StepException(errMsg);
                }
            }
            ...
            logger.info(LOGTAG + "Getting properties from preceding steps...");
            ProvisioningStep step3 = getProvisioningStepByType("DETERMINE_VPC_CIDR");
            ...
            if (step3 != null) {
                ...
                vpn1InsideTunnelCidr1 = getResultProperty(step3, "vpn1InsideTunnelCidr1");
                ...
                vpn1InsideTunnelCidr2 = getResultProperty(step3, "vpn1InsideTunnelCidr2");
                ...
                vpn1CustomerGatewayIp = getResultProperty(step3, "vpn1CustomerGatewayIp");
                ...
                vpn2InsideTunnelCidr1 = getResultProperty(step3, "vpn2InsideTunnelCidr1");
                ...
                vpn2InsideTunnelCidr2 = getResultProperty(step3, "vpn2InsideTunnelCidr2");
                ...
                vpn2CustomerGatewayIp = getResultProperty(step3, "vpn2CustomerGatewayIp");
            ...
            logger.info(LOGTAG + "Getting properties from preceding steps...");
            ProvisioningStep step4 = getProvisioningStepByType("COMPUTE_VPC_SUBNETS");
            ...
            if (step4 != null) {
                ...
                public2Subnet = getResultProperty(step4, "public2Subnet");
                ...
                private1Subnet = getResultProperty(step4, "private1Subnet");
                ...
                private2Subnet = getResultProperty(step4, "private2Subnet");
                ...
                String errMsg = "Step COMPUTE_VPC_SUBNETS not found. Cannot determine account sequence number.";
                logger.error(LOGTAG + errMsg);
                throw new StepException(errMsg);
            }
            ...
            if (vpcpr.getType().equals("1") && accountId != null) {
                logger.info(LOGTAG + "This is a request for a type 1 VPC and the accountNumber is " + accountId +
                        ". Sending a Stack.Generate-Request to create the rhedcloud-aws-vpc-type1 stack in the account.");
                ...
                try {
                    ...
                    // Region
                    VirtualPrivateCloudRequisition vpcr = getVirtualPrivateCloudProvisioning().getVirtualPrivateCloudRequisition();
            ...
            // number, log it and add result props.
                ...
                logger.info(LOGTAG + "This is not a type 1 VPC or there is no account number. No need to create the rhedcloud-aws-vpc-type1 stack.");
