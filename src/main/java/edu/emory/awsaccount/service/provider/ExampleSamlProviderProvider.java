 ...
 *
 */
public class ExampleSamlProviderProvider extends OpenEaiObject implements SamlProviderProvider {
     ...
     */
    @Override
    public List<SamlProvider> query(SamlProviderQuerySpecification querySpec) throws ProviderException {
        ...
        // Otherwise return the Stack from the VPC map
            ...
            List<SamlProvider> stackList = new ArrayList();
     ...
     */
    @Override
    public void create(SamlProvider req) throws ProviderException {
     ...
     * @see StackProvider.java
     */
    public void update(SamlProvider stack) throws ProviderException {
