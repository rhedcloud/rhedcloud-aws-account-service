 ...
 *
 */
public class ExampleAccountOrganizationMembershipProvider extends OpenEaiObject implements AccountOrganizationMembershipProvider {
    ...
    private HashMap<String, AccountOrganizationMembership> m_stackMap = new HashMap();
    private String LOGTAG = "[ExampleAccountOrganizationMembershipProvider] ";
    ...
    public void init(AppConfig aConfig) throws ProviderException {
        ...
        try {
            pConfig = (PropertyConfig) aConfig.getObject("AccountOrganizationMembershipProviderProperties");
    ...
    public List<AccountOrganizationMembership> query(AccountOrganizationMembershipQuerySpecification querySpec) throws ProviderException {
        ...
        // Otherwise return the Stack from the VPC map
            ...
            List<AccountOrganizationMembership> stackList = new ArrayList();
    ...
    public void create(AccountOrganizationMembership req) throws ProviderException {
        ...
        AccountOrganizationMembership stack = new AccountOrganizationMembership();
        try {
            stack = (AccountOrganizationMembership) m_appConfig.getObjectByType(stack.getClass().getName());
     ...
     * @see StackProvider.java
     */
    public void update(AccountOrganizationMembership stack) throws ProviderException {
