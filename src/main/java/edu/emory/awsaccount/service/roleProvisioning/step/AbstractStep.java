...
public abstract class AbstractStep {
	...
	private String m_roleProvisioningId = null;
	...
	private RoleProvisioning m_ad = null;
	private RoleProvisioningProvider m_adp = null;
	...
	public void init(String roleProvisioningId, Properties props, AppConfig aConfig, RoleProvisioningProvider adp)
		...
		setRoleProvisioningId(roleProvisioningId);
		...
		setRoleProvisioningProvider(adp);
		setProperties(props);
		...
		// The RoleProvisioning object for the specified id does not exist. This is a fatal step error.
			...
			String errMsg = "No RoleProvisioning object found for RoleProvisioningId " + roleProvisioningId + ". Can't continue.";
			throw new StepException(errMsg);
		}
		
		// Set the step tag value.
		String stepTag = "[RoleProvisioningId " + getRoleProvisioningId() + "][Step-" + getStepId() + "] ";
		setStepTag(stepTag);
	...
	private String getRoleProvisioningId() { return m_roleProvisioningId; }
	private void setRoleProvisioningId(String roleProvisioningId) throws StepException {
		if (roleProvisioningId == null) {
			String errMsg = "RoleProvisioningId is null. StepId is a required property.";
			logger.error(LOGTAG + errMsg);
			throw new StepException(errMsg);
		}

		m_roleProvisioningId = roleProvisioningId;
	}
	...
	private void setStepTag(String stepTag) throws StepException { m_stepTag = stepTag; }
	...
	private void setRoleProvisioningProvider(RoleProvisioningProvider adp) { m_adp = adp; }
	protected RoleProvisioningProvider getRoleProvisioningProvider() { return m_adp; }
	private void setRoleProvisioning(RoleProvisioning ad) { m_ad = ad; }
	protected RoleProvisioning getRoleProvisioning() { return m_ad; }
	...
	protected ProvisioningStep getProvisioningStepById(String stepId) {
		...
		List<ProvisioningStep> steps = roleProvisioning.getProvisioningStep();
	...
	public void addResultProperty(String key, String value) throws StepException {
		...
		Property newProp = m_ad.newProvisioningStep().newProperty();
		try {
			newProp.setKey(key);
	...
	public void update(String status, String result) throws StepException {
		...
		ProvisioningStep dStep = getProvisioningStepById(getStepId());
	...
	private void queryForRoleProvisioningBaseline() throws StepException {
	    ...
	    try {
	    	querySpec.setRoleProvisioningId(getRoleProvisioningId());
	    }
	    catch (EnterpriseFieldException efe) {
