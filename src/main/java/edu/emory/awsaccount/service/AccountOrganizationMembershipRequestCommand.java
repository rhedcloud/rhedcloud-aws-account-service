...
//import com.amazon.aws.moa.jmsobjects.provisioning.v1_0.AccountOrganizationMembershipProvider;
// AWS MOA objects
//import com.amazon.aws.moa.objects.resources.v1_0.AccountOrganizationMembershipProviderQuerySpecification;
//import com.amazon.aws.moa.objects.resources.v1_0.AccountOrganizationMembershipProviderRequisition;
//import com.amazon.aws.moa.jmsobjects.cloudformation.v1_0.AccountOrganizationMembership;

// VPC Provider Implementation
//import edu.emory.awsaccount.service.provider.AccountOrganizationMembershipProviderProvider;
...
/**
 * This command handles requests for AccountOrganizationMembership objects.
 * Specifically, it handles a Query-Request, a Generate-Request, an
 * Update-Request, and a Delete-Request for this object with the following
 * high-level logic:
 * <P>
 * <OL>
 * <LI>com.amazon.aws.Provisioning.AccountOrganizationMembership.Query-Request
 * (<A HREF=
 * "https://svn.service.emory.edu:8443/cgi-bin/viewvc.cgi/emoryoit/message/releases/com/amazon/aws/Provisioning/AccountOrganizationMembership/1.0/dtd/Query-Request.dtd?view=markup"
 * >Definition</A> | <A HREF=
 * "https://svn.service.emory.edu:8443/cgi-bin/viewvc.cgi/emoryoit/message/releases/com/amazon/aws/Provisioning/AccountOrganizationMembership/1.0/xml/Query-Request.xml?view=markup"
 * >Sample Message</A>)
 * <UL>
 * <LI>Convert the JMS message to an XML document</LI>
 * <LI>Build a message object from the XML document for the
 * AccountOrganizationMembershipQuerySpecification</LI>
 * <LI>Invoke the query method of the configured AccountOrganizationMembership
 * provider</LI>
 * <LI>Build the message response from the results of the query operation. This
 * should contain a list of AccountOrganizationMembership objects from which one
 * can build a list of AccountOrganizationMembership objects.</LI>
 * <LI>Return the response</LI>
 * </UL>
 * </LI>
 * <LI>com.amazon.aws.Provisioning.AccountOrganizationMembership.Generate-Request
 * (<A HREF=
 * "https://svn.service.emory.edu:8443/cgi-bin/viewvc.cgi/emoryoit/message/releases/com/amazon/aws/Provisioning/AccountOrganizationMembership/1.0/dtd/Generate-Request.dtd?view=markup"
 * >Definition</A> | <A HREF=
 * "https://svn.service.emory.edu:8443/cgi-bin/viewvc.cgi/emoryoit/message/releases/com/amazon/aws/Provisioning/AccountOrganizationMembership/1.0/xml/Generate-Request.xml?view=markup"
 * >Sample Message</A>)
 * <UL>
 * <LI>Convert the JMS message to and XML document</LI>
 * <LI>Build a message object from the XML document for the
 * AccountOrganizationMembershipRequisition object</LI>
 * <LI>Invoke the generate method of the configured
 * AccountOrganizationMembership provider.</LI>
 * <LI>Build the AccountOrganizationMembership object from the results of the
 * generate operation. This should always return a AccountOrganizationMembership
 * in the success case.</LI>
 * <LI>If successful, publish a AccountOrganizationMembership.Create-Sync
 * message</LI>
 * <LI>Build the response to the request message</LI>
 * <LI>Return the response to the request message</LI>
 * </UL>
 * </LI>
 * <LI>com.amazon.aws.Provisioning.AccountOrganizationMembership.Update-Request
 * (<A HREF=
 * "https://svn.service.emory.edu:8443/cgi-bin/viewvc.cgi/emoryoit/message/releases/com/amazon/aws/Provisioning/AccountOrganizationMembership/1.0/dtd/Update-Request.dtd?view=markup"
 * >Definition</A> | <A HREF=
 * "https://svn.service.emory.edu:8443/cgi-bin/viewvc.cgi/emoryoit/message/releases/com/amazon/aws/Provisioning/AccountOrganizationMembership/1.0/xml/Update-Request.xml?view=markup"
 * >Sample Message</A>)
 * <UL>
 * <LI>Convert the JMS message to and XML document</LI>
 * <LI>Build a message objects for the XML document for the baseline and new
 * AccountOrganizationMembership objects</LI>
 * <LI>Perform baseline comparison</LI>
 * <LI>Invoke the update method of the configured AccountOrganizationMembership
 * provider</LI>
 * <LI>If successful, publish a AccountOrganizationMembership.Update-Sync
 * message</LI>
 * <LI>Build the response to the request message</LI>
 * <LI>Return the response to the request message</LI>
 * </UL>
 * </LI>
 * <LI>com.amazon.aws.Provisioning.AccountOrganizationMembership.Delete-Request
 * (<A HREF=
 * "https://svn.service.emory.edu:8443/cgi-bin/viewvc.cgi/emoryoit/message/releases/com/amazon/aws/Provisioning/AccountOrganizationMembership/1.0/dtd/Delete-Request.dtd?view=markup"
 * >Definition</A> | <A HREF=
 * "https://svn.service.emory.edu:8443/cgi-bin/viewvc.cgi/emoryoit/message/releases/com/amazon/aws/Provisioning/AccountOrganizationMembership/1.0/xml/Delete-Request.xml?view=markup"
 * >Sample Message</A>)
 * <UL>
 * <LI>Convert the JMS message to and XML document</LI>
 * <LI>Build a message object from the XML document for the
 * AccountOrganizationMembership object</LI>
 * <LI>Invoke the delete method of the configured AccountOrganizationMembership
 * provider</LI>
 * <LI>If successful, publish a AccountOrganizationMembership.Delete-Sync
 * message</LI>
 * <LI>Build the response to the request message</LI>
 * <LI>Return the response to the request message</LI>
 * </UL>
...
public class AccountOrganizationMembershipRequestCommand extends AwsAccountRequestCommand implements RequestCommand {
    private static String LOGTAG = "[AccountOrganizationMembershipRequestCommand] ";
    private static Logger logger = Logger.getLogger(AccountOrganizationMembershipRequestCommand.class);
    private AccountOrganizationMembershipProvider m_provider = null;
    ...
    public AccountOrganizationMembershipRequestCommand(CommandConfig cConfig) throws InstantiationException {
        ...
        // Initialize a AccountOrganizationMembershipProviderProvider
        String className = getProperties().getProperty("AccountOrganizationMembershipProviderClassName");
        if (className == null || className.equals("")) {
            String errMsg = "No AccountOrganizationMembershipProviderClassName property " + "specified. Can't continue.";
            logger.fatal(LOGTAG + errMsg);
            throw new InstantiationException(errMsg);
        }
        logger.info(LOGTAG + "AccountOrganizationMembershipProviderClassName is: " + className);

        AccountOrganizationMembershipProvider provider = null;
        try {
            ...
            provider = (AccountOrganizationMembershipProvider) Class.forName(className).newInstance();
            logger.info(LOGTAG + "Initializing AccountOrganizationMembershipProvider: " + provider.getClass().getName());
            provider.init(getAppConfig());
            logger.info(LOGTAG + "AccountOrganizationMembershipProvider initialized.");
            ...
            String errMsg = "An error occurred initializing the " + "AccountOrganizationMembershipProvider " + className
        ...
        // Get a configured AccountOrganizationMembership from AppConfig.
        AccountOrganizationMembership saml = new AccountOrganizationMembership();
        try {
            saml = (AccountOrganizationMembership) getAppConfig().getObjectByType(saml.getClass().getName());
        } catch (EnterpriseConfigurationObjectException eoce) {
        ...
        // Get a AccountOrganizationMembershipQuerySpecification from AppConfig.
        AccountOrganizationMembershipQuerySpecification querySpec = new AccountOrganizationMembershipQuerySpecification();
        try {
            querySpec = (AccountOrganizationMembershipQuerySpecification) getAppConfig().getObjectByType(querySpec.getClass().getName());
        } catch (EnterpriseConfigurationObjectException eoce) {
            String errMsg = "Error retrieving an object from AppConfig: " + "The exception" + "is: " + eoce.getMessage();
            logger.error(LOGTAG + errMsg);
            throw new InstantiationException(errMsg);
        ...
        // // Get a AccountOrganizationMembershipRequisition from AppConfig.
        // AccountOrganizationMembershipRequisition req = new
        // AccountOrganizationMembershipRequisition();
        // try {
        // req = (AccountOrganizationMembershipRequisition) getAppConfig()
     ...
     *             AccountOrganizationMembershipProviderProvider to perform each
     *             operation.
     */
    @Override
    public final Message execute(int messageNumber, Message aMessage) throws CommandException {
        ...
        // AccountOrganizationMembershipProvider object; if not, reply with an
        // error.
        if (msgObject.equalsIgnoreCase("AccountOrganizationMembership") == false) {
            String errType = "application";
            String errCode = "OpenEAI-1001";
            String errDesc = "Unsupported message object: " + msgObject + ". This command expects 'AccountOrganizationMembership'.";
        ...
        // Get a configured AccountOrganizationMembershipRequisition from
        // AppConfig.
        AccountOrganizationMembership accountAlias = new AccountOrganizationMembership();
        TestId testId = new TestId();
        try {
            accountAlias = (AccountOrganizationMembership) getAppConfig().getObjectByType(accountAlias.getClass().getName());
        ...
        if (msgAction.equalsIgnoreCase("Create")) {
            logger.info(
                    LOGTAG + "Handling a com.amazon.aws.Provisioning.AccountOrganizationMembershipProvider.Create-Request" + " message.");
            Element eCreateObject = inDoc.getRootElement().getChild("DataArea").getChild("NewData")
                    .getChild("AccountOrganizationMembership");
            ...
            if (eCreateObject == null) {
                ...
                String errDesc = "Invalid element found in the Generate-Request "
                        + "message. This command expects a AccountOrganizationMembership";
                logger.error(LOGTAG + errDesc);
            ...
            // Now build a AccountOrganizationMembershipRequisition object from
            // the element in
            // the
            // message.
            try {
            ...
            // Generate the AccountOrganizationMembership object using the
            // provider
            // implementation.
            logger.info(LOGTAG + "Creating a AccountOrganizationMembership...");

            // AccountOrganizationMembershipProvider saml = null;
            try {
                long generateStartTime = System.currentTimeMillis();
                getProvider().create(accountAlias);
                long generateTime = System.currentTimeMillis() - generateStartTime;
                logger.info(LOGTAG + "Create AccountOrganizationMembership in " + generateTime + " ms.");
                if (eTestId != null)
                ...
                String errDesc = "An error occurred generating the AccountOrganizationMembership. The " + "exception is: "
                        + pe.getMessage();
                logger.error(LOGTAG + errDesc);
                logger.error("Message sent in is: \n" + getMessageBody(inDoc));
                ArrayList errors = new ArrayList();
            ...
            logger.info(LOGTAG + "Created AccountOrganizationMembership ");
            ...
            try {
                ...
                if (getVerbose())
                    logger.info(LOGTAG + "Publishing AccountOrganizationMembership.Create-Sync message...");
                ...
                logger.info(LOGTAG + "Published AccountOrganizationMembership.Create-Sync" + " message.");
            } catch (EnterpriseObjectSyncException eose) {
                String errMsg = "An error occurred publishing the AccountOrganizationMembership.Create-Sync"
                        + " message after generating a AccountOrganizationMembership. The " + "exception is: " + eose.getMessage();
                logger.error(LOGTAG + errMsg);
                throw new CommandException(errMsg, eose);
            } catch (JMSException jmse) {
                String errMsg = "An error occurred publishing the AccountOrganizationMembership.Create-Sync"
                        + " message after generating a AccountOrganizationMembership. The " + "exception is: " + jmse.getMessage();
                logger.error(LOGTAG + errMsg);
            ...
            // Element eAccountOrganizationMembership = null;
            // try {
            // eAccountOrganizationMembership = (Element)
            // reqAccountOrganizationMembershipProvider.buildOutputFromObject();
            // } catch (EnterpriseLayoutException ele) {
            ...
            // }
            // localResponseDoc.getRootElement().getChild("DataArea").addContent(eAccountOrganizationMembership);
        ...
        if (msgAction.equalsIgnoreCase("Query")) {
            logger.info(LOGTAG + "Handling an com.amazon.aws.Provisioning.AccountOrganizationMembership." + "Query-Request message.");
            Element eQuerySpec = inDoc.getRootElement().getChild("DataArea").getChild("AccountOrganizationMembershipQuerySpecification");

            // Get a configured query object from AppConfig.
            AccountOrganizationMembershipQuerySpecification querySpec = new AccountOrganizationMembershipQuerySpecification();
            try {
                querySpec = (AccountOrganizationMembershipQuerySpecification) getAppConfig()
            ...
            // Query for the AccountOrganizationMembership from the provider.
            logger.info(LOGTAG + "Querying for the AccountOrganizationMembership...");
            ...
            try {
                ...
                logger.info(LOGTAG + "Queried for AccountOrganizationMembership in " + queryTime + "ms.");
            } catch (ProviderException pe) {
                // There was an error generating the identity
                String errType = "application";
                String errCode = "AwsAccountService-100X";
                String errDesc = "An error occurred querying for the AccountOrganizationMembership." + "The " + "exception is: "
                        + pe.getMessage();
                logger.error(LOGTAG + errDesc);
                logger.error("Message sent in is: \n" + getMessageBody(inDoc));
                ArrayList errors = new ArrayList();
            ...
            if (results != null && results.size() > 0) {
                ...
                for (int i = 0; i < results.size(); i++) {
                    Element eAccountOrganizationMembership = null;
                    try {
                        AccountOrganizationMembership stack = (AccountOrganizationMembership) results.get(i);
                        eAccountOrganizationMembership = (Element) stack.buildOutputFromObject();
                        stackList.add(eAccountOrganizationMembership);
                        if (eTestId != null)
                            stack.setTestId(testId);
                    } catch (EnterpriseLayoutException ele) {
                        String errMsg = "An error occurred serializing " + "AccountOrganizationMembership object to an XML element. "
        ...
        if (msgAction.equalsIgnoreCase("Delete")) {
            logger.info(LOGTAG + "Handling a com.amazon.aws.Provisioning." + "AccountOrganizationMembership.Delete-Request message.");
            Element eAccountOrganizationMembership = inDoc.getRootElement().getChild("DataArea").getChild("DeleteData")
                    .getChild("AccountOrganizationMembership");

            // Verify that the AccountOrganizationMembership element is not
            // null. If it is
            // null, reply with an error.
            if (eAccountOrganizationMembership == null) {
                String errType = "application";
                String errCode = "OpenEAI-1015";
            ...
            try {
                samlProvider = (AccountOrganizationMembership) getAppConfig().getObjectByType(samlProvider.getClass().getName());
            } catch (EnterpriseConfigurationObjectException eoce) {
                String errMsg = "Error retrieving an object from AppConfig: The exception" + "is: " + eoce.getMessage();
                logger.error(LOGTAG + errMsg);
                throw new CommandException(errMsg);
            ...
            try {
                samlProvider.buildObjectFromInput(eAccountOrganizationMembership);
                if (eTestId != null)
                    testId.buildObjectFromInput(eTestId);
            ...
            // Delete the AccountOrganizationMembership object using the
            // provider.
            logger.info(LOGTAG + "Deleting a AccountOrganizationMembership...");

            try {
                long deleteStartTime = System.currentTimeMillis();
                getProvider().delete(samlProvider);
                long deleteTime = System.currentTimeMillis() - deleteStartTime;
                logger.info(LOGTAG + "Deleted AccountOrganizationMembership in " + deleteTime + " ms.");
            } catch (ProviderException pe) {
                // There was an error deleting the VPC
                String errType = "application";
                String errCode = "AwsAccountService-100X";
                String errDesc = "An error occurred deleting the AccountOrganizationMembership " + "The " + "exception is: "
                        + pe.getMessage();
                logger.error(LOGTAG + errDesc);
                logger.error("Message sent in is: \n" + getMessageBody(inDoc));
                ArrayList errors = new ArrayList();
            ...
            try {
                MessageProducer producer = getProducerPool().getProducer();
                if (getVerbose())
                    logger.info(LOGTAG + "Publishing AccountOrganizationMembership.Delete-Sync message...");
                samlProvider.deleteSync("delete", (SyncService) producer);
                logger.info(LOGTAG + "Published AccountOrganizationMembership.Delete-Sync" + " message.");
            } catch (EnterpriseObjectSyncException eose) {
                String errMsg = "An error occurred publishing the AccountOrganizationMembership" + ".Delete-Sync message after deleting "
                        + "the AccountOrganizationMembership. The " + "exception is: " + eose.getMessage();
                logger.error(LOGTAG + errMsg);
                throw new CommandException(errMsg, eose);
            } catch (JMSException jmse) {
                String errMsg = "An error occurred publishing the AccountOrganizationMembership" + ".Delete-Sync message after deleting "
                        + "the AccountOrganizationMembership. The " + "exception is: " + jmse.getMessage();
                logger.error(LOGTAG + errMsg);
                throw new CommandException(errMsg, jmse);
            }
    ...
    /**
     * @param AccountOrganizationMembershipProviderProvider
     *            , the AccountOrganizationMembership provider
     *            <P>
     *            Sets the AccountOrganizationMembership provider for this
     *            command.
     */
    protected void setProvider(AccountOrganizationMembershipProvider provider) {
        m_provider = provider;
    }

    /**
     * @return AccountOrganizationMembershipProviderProvider, the
     *         AccountOrganizationMembership provider
     *         <P>
     *         Gets the AccountOrganizationMembership provider for this command.
     */
    protected AccountOrganizationMembershipProvider getProvider() {
        return m_provider;
    }
