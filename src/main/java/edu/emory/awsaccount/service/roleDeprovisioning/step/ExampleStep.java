...
public class ExampleStep extends AbstractStep implements Step {
    ...
    public void init(String provisioningId, Properties props, AppConfig aConfig, RoleDeprovisioningProvider rpp) throws StepException {
        ...
        String LOGTAG = getStepTag() + "[RoleDeprovisioning.ExampleStep.init] ";
    ...
    protected List<Property> run() throws StepException {
        ...
        String LOGTAG = getStepTag() + "[RoleDeprovisioning.ExampleStep.run] ";
    ...
    protected List<Property> simulate() throws StepException {
        long startTime = System.currentTimeMillis();
        String LOGTAG = getStepTag() + "[RoleDeprovisioning.ExampleStep.simulate] ";
    ...
    protected List<Property> fail() throws StepException {
        long startTime = System.currentTimeMillis();
        String LOGTAG = getStepTag() + "[RoleDeprovisioning.ExampleStep.fail] ";
    ...
    public void rollback() throws StepException {
        long startTime = System.currentTimeMillis();
        String LOGTAG = getStepTag() + "[RoleDeprovisioning.ExampleStep.rollback] ";
