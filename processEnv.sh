...
zip uf axis2.war WEB-INF/services/rhedcloud-awsaccount-webservice-1.0.aar
zip uf axis2.war WEB-INF/lib/*
zip uf axis2.war WEB-INF/classes
zip uf axis2.war WEB-INF/modules
zip uf axis2.war WEB-INF/conf
